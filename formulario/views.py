    ...
    def post(self, request):
        ...
        if jd['Nombre'] == "Examen gratis":
            if jd['getPregunta'] == False: #Envía el idExamenXUsuario
                ...
                datos = {'Message': 'Success POST', 'Preguntas': preguntasElegidas, 'IdExamenXUsuario': jd['IdExamenXUsuario'], 'Tiempo': 15}
            ...
            if jd['getPregunta'] == False: #Envía el idExamenXUsuario
                ...
                datos = {'Message': 'Success POST', 'Preguntas': preguntasElegidas, 'IdExamenXUsuario': jd['IdExamenXUsuario'], 'Tiempo': 90}
            ...
            if jd['getPregunta'] == False: #Envía el idExamenXUsuario
                ...
                datos = {'Message': 'Success POST', 'Preguntas': preguntasElegidas, 'IdExamenXUsuario': jd['IdExamenXUsuario'], 'Tiempo': 150}
